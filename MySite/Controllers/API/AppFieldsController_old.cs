...
{
    public class AppFieldsController_old : ApiController
    {
...
/*
        // GET: api/AppFields/Test/1
        [HttpGet]
        [ResponseType(typeof(AppField))]
        public IHttpActionResult Test(string title, int id)
        {
        ...
        // GET: api/AppFieldList/5
        [HttpGet]
        [ResponseType(typeof(AppField))]
        public IHttpActionResult AppFieldList(int id)
        {
            AppField appField = db.AppFields.Find(id);
            if (appField == null)
            {
